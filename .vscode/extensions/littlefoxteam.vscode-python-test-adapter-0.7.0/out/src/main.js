...
function registerTestAdapters(wf, extension, loggerFactory) {
    ...
    const testplanRunner = new testplanTestRunner_1.TestplanTestRunner(idGenerator_1.nextId(), pytestLogger);
    ...
    const testplantConfigurationFactory = new configurationFactory_1.DefaultConfigurationFactory(testplanLogger);
    const adapters = [
        ...
        new pythonTestAdapter_1.PythonTestAdapter(wf, testplanRunner, testplantConfigurationFactory, testplanLogger)
    ];
