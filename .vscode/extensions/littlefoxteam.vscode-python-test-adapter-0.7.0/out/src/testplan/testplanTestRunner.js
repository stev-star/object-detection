...
class TestplanTestRunner {
    ...
    load(config) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const tests = testplanTestCollectionParser_1.parseTestSuites(result.output);
    ...
    run(config, test) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const states = yield testplanJunitTestStatesParser_1.parseTestStates(dirName);
            cleanupCallback();
            return states;
        });
    }
    runTestPlan(config, env, args) {
        ...
        return processRunner_1.runProcess(config.pythonPath(), [testplanPath].concat(args), {
            cwd: config.getCwd(),
            environment: env,
